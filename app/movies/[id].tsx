    ...
    <View className="bg-primary flex-1">
      <ScrollView contentContainerStyle={{ paddingBottom: 80 }}>
        ...
        <View className="flex-row items-center mt-3 px-5">
          ...
          <Text className="text-light-200 mx-2 text-sm">
            {movie?.runtime} min
          </Text>
        </View>

        <View className="flex-row items-center mx-5 mt-2 bg-dark-100 rounded-md py-1 px-2 gap-x-1 self-start">
      ...
      <TouchableOpacity className="bottom-5 left-0 right-0 mx-5 bg-accent rounded-lg py-3.5 flex-row items-center justify-center" onPress={router.back}>
        <Image
          source={icons.arrow}
